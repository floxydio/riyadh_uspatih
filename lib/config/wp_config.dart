class WpConfig {
  ...
  // YOUR WEBISTE URL
  static const String websiteUrl = "https://siln-riyadh.kemdikbud.go.id/";

  // CREDENTIALS
  static const String websiteAdminName = 'Admin-Riyadh';
  static const String websiteAdminPassword = '!E0HKygBM';
  

  //Tag Ids
  static const int featuredTagID = 25;
